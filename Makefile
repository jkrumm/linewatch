...
env: ## Ensure the bearer token and .env exist (idempotent; `up` and `db-import` do this for you)
	@mkdir -p "$(TOKEN_DIR)"
	...
	@# The token travels host file -> .env -> compose `env_file`. Nothing is
	@# bind-mounted into the image.
	@#
